...
BiTextureMapping* bi_texture_mapping_init(BiTextureMapping* texture_mapping,BiTexture* texture)
{
  ...
  texture_mapping->w = 0;
  texture_mapping->h = 0;
  texture_mapping->clipped = false;
  texture_mapping->offset_x = 0;
  texture_mapping->offset_y = 0;
  texture_mapping->outer_w = 0;
  texture_mapping->outer_h = 0;
...
void bi_texture_mapping_set_clip(BiTextureMapping* texture_mapping, uint16_t x, uint16_t y, uint16_t w, uint16_t h)
{
  texture_mapping->clipped = true;
  texture_mapping->offset_x = x;
  texture_mapping->offset_y = y;
  texture_mapping->outer_w = w;
  texture_mapping->outer_h = h;
}

void bi_texture_mapping_unset_clip(BiTextureMapping* texture_mapping)
{
  texture_mapping->clipped = false;
  texture_mapping->offset_x = 0;
  texture_mapping->offset_y = 0;
