...
int main(int argc, char* argv[])
{
  ...
  // foreground
  BiLayer *foreground_layer = bi_layer_init(malloc(sizeof(BiLayer)));
  ...
  BiLayerGroup* foreground_layer_group = bi_layer_group_init(malloc(sizeof(BiLayerGroup)));
  bi_layer_group_add_layer(foreground_layer_group,foreground_layer);
  // background
  BiLayer* background_layer = bi_layer_init(malloc(sizeof(BiLayer)));
  ...
  BiLayerGroup* background_layer_group = bi_layer_group_init(malloc(sizeof(BiLayerGroup)));
