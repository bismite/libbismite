...
int main(int argc, char* argv[])
{
  ...
  bg_layer->textures[3] = bg_layer->root->texture_mapping->texture;
  ...
  bg_layer->textures[0] = tester->texture_mapping->texture;
  bg_layer->textures[1] = face->texture_mapping->texture;
  ...
  layer->textures[0] = tester2->texture_mapping->texture;
  layer->textures[1] = face2->texture_mapping->texture;
