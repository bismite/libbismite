...
int main(int argc, char* argv[])
{
  ...
  bg_layer->textures[3] = bg_layer->root->texture;
  ...
  bg_layer->textures[0] = tester->texture;
  bg_layer->textures[1] = face->texture;
  ...
  layer->textures[0] = tester2->texture;
  layer->textures[1] = face2->texture;
